...
logging.basicConfig(
    level=logging.INFO,
    filename=f'/home/{user}/buckets/b1/experiment_3.log',
...
VERBOSE = False
aug_positives = True
experiment_name = "zlgbm-histfeatures-intra-month-aug-positives"
...
debug_mode = False
sampling_rate = 0.02
results_file = f"/home/{user}/buckets/b1/results.csv"
...
revs = train_models_and_save_results(train_set,X_eval, w_eval, params, seeds, results_file, save_model, n_seeds, experiment_name, fieldnames, user)
