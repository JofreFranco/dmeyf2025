"""
Experimento Lags-Percentiles: Evaluación de features con lag 1 y percentiles
"""
...
def main(config_path, debug=None):
    ...
    n_lags = exp_config.get('n_lags', 1)  # Default para lags_percentiles
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Ejecutar experimento Lags-Percentiles con configuración YAML')
