...
def main(config_path, debug=None):
    ...
    n_deltas = exp_config.get('n_deltas', 2)  # Default para delta_lags2
    n_lags = exp_config.get('n_lags', 2)  # Default para delta_lags2
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Ejecutar experimento Delta-Lags2 con configuración YAML')
