"""
Experimento Just-Lags: Evaluación de features con lag 1 únicamente
"""
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Ejecutar experimento Just-Lags con configuración YAML')
