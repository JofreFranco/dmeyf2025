"""
Experimento Lags2: Evaluación de features con lag 1 y 2
"""
...
def main(config_path, debug=None):
    ...
    n_lags = exp_config.get('n_lags', 2)  # Default para lags2
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Ejecutar experimento Lags2 con configuración YAML')
